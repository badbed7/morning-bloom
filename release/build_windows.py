...
def main():
    ...
    (output / 'release-notes.md').write_text(
        ...
        'New in this release:\n'
        '- Desktop flowers now stay above ordinary folders and apps in independent always-on-top windows.\n'
        '- The fertilizer stock label now shows a live reward countdown and availability state.\n'
        ...
        '- Interactive floating flowers with independent opacity and sunlight.\n'
